...
config = [{
    ...
    # 'name': r'M3D_NCA_Hyp99_98_rwalk', #12 or 13, 54 opt, 
    # 'pretrained':  r'M3D_NCA_Hyp99_rwalk',
    ...
    'name': r'M3D_NCA_Hyp99_98_97_rwalk', #12 or 13, 54 opt, 
    'pretrained':  r'M3D_NCA_Hyp99_98_rwalk',

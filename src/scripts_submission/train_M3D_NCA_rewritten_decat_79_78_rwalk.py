...
config = [{
    ...
    'name': r'M3D_NCA_Prost79_78_rwalk', #12 or 13, 54 opt, 
    'pretrained':  r'M3D_NCA_Prost79_rwalk',
...
agent._initalize_rwalk(fisher, params, scores, 0.4, '78')
agent.train(data_loader, loss_function)
agent.after_train_rwalk('78', data_loader, loss_function)

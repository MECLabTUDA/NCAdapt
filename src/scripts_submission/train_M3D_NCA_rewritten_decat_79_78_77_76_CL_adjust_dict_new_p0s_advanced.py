...
config = [{
    ...
    # 'name': r'M3D_NCA_Prost79_CL_adjust_dict_new_p0s', #12 or 13, 54 opt, 
    ...
    # 'name': r'M3D_NCA_Prost79_78_CL_adjust_dict_new_p0s', #12 or 13, 54 opt, 
    # 'pretrained':  r'M3D_NCA_Prost79_CL_adjust_dict_new_p0s',
    ...
    # 'name': r'M3D_NCA_Prost79_78_77_CL_adjust_dict_new_p0s', #12 or 13, 54 opt, 
    # 'pretrained':  r'M3D_NCA_Prost79_78_CL_adjust_dict_new_p0s',
    ...
    'name': r'M3D_NCA_Prost79_78_77_76_CL_adjust_dict_new_p0s', #12 or 13, 54 opt, 
    'pretrained':  r'M3D_NCA_Prost79_78_77_CL_adjust_dict_new_p0s',
...
# Trainiere freeze(m), i3, a3 (epochs//2)
ca1._freeze_model_full()
ca1._un_freeze_modules('3')

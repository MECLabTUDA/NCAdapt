...
config = [{
    ...
    # 'name': r'M3D_NCA_Hyp99_CL_adjust_dict_new_p0s_ewc', #12 or 13, 54 opt,
    ...
    # 'name': r'M3D_NCA_Hyp99_98_CL_adjust_dict_new_p0s_ewc', #12 or 13, 54 opt, 
    # 'pretrained':  r'M3D_NCA_Hyp99_CL_adjust_dict_new_p0s_ewc',
    ...
    'name': r'M3D_NCA_Hyp99_98_97_CL_adjust_dict_new_p0s_ewc', #12 or 13, 54 opt, 
    'pretrained':  r'M3D_NCA_Hyp99_98_CL_adjust_dict_new_p0s_ewc',

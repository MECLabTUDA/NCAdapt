...
config = [{
    ...
    'name': r'M3D_NCA_Hyp99_98_97_CL_adjust_dict_new_p0s', #12 or 13, 54 opt, 
...
# Trainiere freeze(m), i2, a2 (epochs//2)
...
# Trainiere m, freeze(i2, a2) (epochs//2)
agent.model._un_freeze_model_full()
agent.model._freeze_modules('0')
agent.model._freeze_modules('1')
agent.model._freeze_modules('2')

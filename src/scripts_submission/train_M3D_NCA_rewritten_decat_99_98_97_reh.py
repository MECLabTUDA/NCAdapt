...
config = [{
    ...
    # 'name': r'M3D_NCA_Hyp99_reh', #12 or 13, 54 opt,
    ...
    # 'name': r'M3D_NCA_Hyp99_98_reh', #12 or 13, 54 opt, 
    # 'pretrained':  r'M3D_NCA_Hyp99_reh',

    'img_path': r"/media/aranem_locale/AR_subs_exps/MICCAI_2024/MICCAI_2024_raw_data/Task97_DecathHip_reh/imagesTr/",
    'label_path': r"/media/aranem_locale/AR_subs_exps/MICCAI_2024/MICCAI_2024_raw_data/Task97_DecathHip_reh/labelsTr/",
    'name': r'M3D_NCA_Hyp99_98_97_reh', #12 or 13, 54 opt, 
    'pretrained':  r'M3D_NCA_Hyp99_98_reh',
...
hyp99_test = Dataset_NiiGz_3D_customPath(resize=True, size=(64, 64, 48), imagePath=r"/media/aranem_locale/AR_subs_exps/MICCAI_2024/MICCAI_2024_raw_data/Task97_DecathHip/imagesTr", labelPath=r"/media/aranem_locale/AR_subs_exps/MICCAI_2024/MICCAI_2024_raw_data/Task97_DecathHip/labelsTr")

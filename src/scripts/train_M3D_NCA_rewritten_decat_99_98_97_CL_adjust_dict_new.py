...
from src.models.Model_M3DNCA import M3DNCA_CL_new_module_dict_new
...
config = [{
    ...
    # 'name': r'M3D_NCA_Hyp99_CL_adjust_dict_new', #12 or 13, 54 opt,
    ...
    # 'name': r'M3D_NCA_Hyp99_98_CL_adjust_dict_new', #12 or 13, 54 opt, 
    # 'pretrained':  r'M3D_NCA_Hyp99_CL_adjust_dict_new',
    ...
    'name': r'M3D_NCA_Hyp99_98_97_CL_adjust_dict_new', #12 or 13, 54 opt, 
    'pretrained':  r'M3D_NCA_Hyp99_98_CL_adjust_dict_new',
...
ca1 = M3DNCA_CL_new_module_dict_new(config[0]['channel_n'], config[0]['cell_fire_rate'], device, hidden_size=config[0]['hidden_size'], kernel_size=7, input_channels=config[0]['input_channels'], output_channels=config[0]['output_channels'], levels=2, scale_factor=4, steps=20, nr_modules=config[0]['nr_modules']).to(device)

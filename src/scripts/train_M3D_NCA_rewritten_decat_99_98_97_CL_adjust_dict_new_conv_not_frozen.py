...
from src.models.Model_M3DNCA import M3DNCA_CL_new_module_dict_new_no_freeze_convs
...
config = [{
    ...
    # 'name': r'M3D_NCA_Hyp99_CL_adjust_dict_new_freeze_no_convs', #12 or 13, 54 opt,
    ...
    # 'name': r'M3D_NCA_Hyp99_98_CL_adjust_dict_new_freeze_no_convs', #12 or 13, 54 opt, 
    # 'pretrained':  r'M3D_NCA_Hyp99_CL_adjust_dict_new_freeze_no_convs',
    ...
    'name': r'M3D_NCA_Hyp99_98_97_CL_adjust_dict_new_freeze_no_convs', #12 or 13, 54 opt, 
    'pretrained':  r'M3D_NCA_Hyp99_98_CL_adjust_dict_new_freeze_no_convs',
    ...
    'train_model':1,
    # Data
    'input_size': [(9, 12, 10), (36, 48, 40)] ,    #[(9, 12, 10), (36, 48, 40)]
    'scale_factor': 4,
...
ca1 = M3DNCA_CL_new_module_dict_new_no_freeze_convs(config[0]['channel_n'], config[0]['cell_fire_rate'], device, hidden_size=config[0]['hidden_size'], kernel_size=7, input_channels=config[0]['input_channels'], output_channels=config[0]['output_channels'], levels=2, scale_factor=4, steps=20, nr_modules=config[0]['nr_modules']).to(device)
# Freeze other heads and update the weights with the current trained moduls
ca1._freeze_modules('2', clone_state=None)
ca1._un_freeze_convs()
...
### EVAL DATASETS
# Use the first head for first task, second head for second and third head for third task

...
config = [{
    ...
    'name': r'UNet_Hyp99_98_fdr', #12 or 13, 54 opt, 
    'pretrained':  r'UNet_Hyp99_fdr',
    ...
    # 'name': r'UNet_Hyp99_98_97_fdr', #12 or 13, 54 opt, 
    # 'pretrained':  r'UNet_Hyp99_98_fdr',
...
# hyp99_test = Dataset_NiiGz_3D_customPath(resize=True, size=(36, 48, 40), imagePath=r"/media/aranem_locale/AR_subs_exps/WACV_2025/WACV_2025_raw_data/Task97_DecathHip/imagesTr", labelPath=r"/media/aranem_locale/AR_subs_exps/WACV_2025/WACV_2025_raw_data/Task97_DecathHip/labelsTr")

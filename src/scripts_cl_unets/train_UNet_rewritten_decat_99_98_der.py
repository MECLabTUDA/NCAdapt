...
config = [{
    ...
    # 'name': r'UNet_Hyp99_der', #12 or 13, 54 opt,
    ...
    'name': r'UNet_Hyp99_98_der', #12 or 13, 54 opt, 
    'pretrained':  r'UNet_Hyp99_der',
    ...
    # 'name': r'UNet_Hyp99_98_97_der', #12 or 13, 54 opt, 
    # 'pretrained':  r'UNet_Hyp99_98_der',
...
agent.end_task_DER(data_loader)
